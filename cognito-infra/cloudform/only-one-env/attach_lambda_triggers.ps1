...
# Usage: .\attach_lambda_triggers.ps1 -Profile lb_mui
...
$StackName = "cognito-infra"

# --- Get Lambda ARN and Pool IDs from stack outputs ---
...
foreach ($Pool in $Pools) {
    ...
    aws lambda add-permission `
        ...
        --statement-id  "cognito-$($Pool.Name.ToLower())" `
