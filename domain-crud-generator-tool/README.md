...
```bash
node index.js Product jp.brycen.domain D:\Work\Projects\test-spring-baseline\src\main\java
```

This will generate the following structure:

```
D:\Work\Projects\test-spring-baseline\src\main\java\jp\brycen\domain\product\
├── controller\
