...
if (args.length < 3) {
  ...
  console.log('Example: node index.js Product jp.brycen.domain D:\\Work\\Projects\\test-spring-baseline\\src\\main\\java');
  process.exit(1);
}

const entityName = args[0]; // e.g., "Product"
const basePackage = args[1]; // e.g., "jp.brycen.domain"
const basePath = args[2]; // e.g., "D:\Work\Projects\test-spring-baseline\src\main\java"
